...
# 1. Define the inputs that go into the OpenMDAO group from CSDL
####################################################################

# Inputs are defined within a dictionary with keys as names of inputs
# in the OpenMDAO group and values as csdl.Variable objects.
...
# 3. Generate an OpenMDAOExplicitOperation object from the OpenMDAO group
#######################################################################################
